...
},{"insert-css":2,"riot":3}],6:[function(require,module,exports){
'use strict';
...
var headerCss = (require('insert-css')("._8beb63b6 {\n    padding: 0 0.5em;\n  }\n\n  ._8beb63b6 [type=text] {\n    width: calc(100% - 2em);\n    margin-left: 2em;\n    padding: 1em 0;\n    border: none;\n    font-size: 1em;\n  }") || true) && "_8beb63b6";

var sectionCss = (require('insert-css')("._5897ffe9 {\n    padding: 0 0.5em;\n    position: relative;\n    background-color: white;\n  }\n\n  ._5897ffe9 > [type=checkbox] {\n    position: absolute;\n    top: -3em;\n  }\n\n  ._5897ffe9 ul {\n    list-style-type: none;\n    padding: 0;\n    margin: 0;\n  }\n\n  ._5897ffe9 li {\n    position: relative;\n    padding: 0.5em 0;\n  }") || true) && "_5897ffe9";

var footerCss = (require('insert-css')("._7dc74d0c {\n    font-size: 0.8em;\n    padding: 0.5em;\n  }\n\n  ._7dc74d0c .filters {\n    width: 40%;\n    margin: 0 auto;\n  }\n\n  ._7dc74d0c .filter {\n    display: inline-block;\n    padding: 0.2em;\n  }\n\n  ._7dc74d0c .remainingCount {\n    padding: 0.2em;\n    float: left;\n  }\n\n  ._7dc74d0c .clearCompleted {\n    padding: 0.2em;\n    float: right;\n  }") || true) && "_7dc74d0c";
...
module.exports = riot.tag('todo-list', '\n<header class="' + headerCss + '">\n  <form onsubmit="{onAddItem}">\n    <input id="newTodoTitle" type="text" placeholder="What needs to be done?" autofocus />\n  </form>\n</header>\n<section if="{items.length}" class="' + sectionCss + '">\n  <input type="checkbox" __checked="{areAllCompleted()}" onclick="{onToggleAllCompleted}" />\n  <ul>\n    <li each="{item in filteredItems()}">\n      <todo-item item="{item}" dispatcher="{parent.dispatcher}"></todo-item>\n    </li>\n  </ul>\n</section>\n<footer if="{items.length}" class="' + footerCss + '">\n  <span class="remainingCount">{countUncompleted()} item{countUncompleted() !== 1 ? \'s\' : \'\'} left</span>\n  <a href="#" onclick="{onClearCompleted}" class="clearCompleted">Clear completed</a>\n  <div class="filters">\n    <a each="{key, filter in filters}" href="/#/{key}" class="filter {active: activeFilter === key}">{filter.title}</a>\n  </div>\n</footer>\n', function (opts) {
  ...
  this.filters = {
    ...
    active: { func: function func(items) {
        return items.filter(function (item) {
          return !item.completed;
        });
      }, title: 'Active' },
    completed: { func: function func(items) {
        return items.filter(function (item) {
          return item.completed;
        });
      }, title: 'Completed' }
  ...
  this.countUncompleted = function (_) {
